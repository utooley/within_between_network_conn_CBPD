...
$SNGL run --cleanenv -B /data:/mnt $SIMG \
  ...
  -d /mnt/jux/mackey_group/Ursula/projects/in_progress/within_between_network_conn_CBPD/code/ppc/fc-36p-gsr-meancsfwm-censor-contig5-fd1.25-dv2-dropvols.dsn \
  -o /mnt/picsl/mackey_group//BPD/CBPD_bids/derivatives/xcpEngine_gsr_censor_5contig_fd1.25dvars2_drpvls \
  -i $TMPDIR
