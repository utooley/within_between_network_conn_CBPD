...
#load(paste0(network_dir,"/CBPD_n64_schaefer400_allruns_FD1outliers30.Rdata"))
#load(paste0(network_dir,"/CBPD_n82_FD.5mthresh_schaefer400_allruns.Rdata"))
#load(paste0(network_dir,"/CBPD_n85_schaefer400_allruns_FD1outliers50.RData"))
...
saveRDS(vect,"~/Documents/projects/in_progress/within_between_network_conn_CBPD/data/imageData/gsr_spkreg_fd0.25dvars1.75_drpvls/n83_all_edges.RData")
...
#n64_all_edges<- readRDS("~/Documents/projects/in_progress/within_between_network_conn_CBPD/data/imageData/gsr_spkreg_fd0.25dvars1.75_drpvls/n64_all_edges.RData");n64_all_edges <- n64_all_edges[,-1]
n85_all_edges<- readRDS("~/Documents/projects/in_progress/within_between_network_conn_CBPD/data/imageData/gsr_spkreg_fd0.25dvars1.75_drpvls/n83_all_edges.RData");n64_all_edges <- n85_all_edges[,-1]
```
...
edgewise_age_pvals<- mclapply(1:79800, function(x) { summary(lm(n64_all_edges[,x]~main_unique$age_scan+main_unique$male+main_unique$fd_mean_avg+main_unique$avgweight+main_unique$totalSizet))$coef[2,4]}, mc.cores = 4)
...
#get age betas
edgewise_age_betas<- mclapply(1:79800, function(x) { lm.beta(lm(n64_all_edges[,x]~main_unique$age_scan+main_unique$male+main_unique$fd_mean_avg+main_unique$avgweight+main_unique$totalSizet))$standardized.coefficients[[2]]}, mc.cores = 4)
edgewise_age_betas <- unlist(edgewise_age_betas)
#save for reloading in future
save(edgewise_age_pvals_fdr, edgewise_age_betas,file= "~/Documents/projects/in_progress/within_between_network_conn_CBPD/data/imageData/gsr_spkreg_fd0.25dvars1.75_drpvls/edgewise_age_effects_all_cov_n83.Rdata")
...
coloredmeshes=vis.region.values.on.subject(subjects_dir, 'fsaverage6', 'Schaefer2018_400Parcels_7Networks_order',  num_of_sig_age_edges_lh, 
                             num_of_sig_age_edges_rh, makecmap_options = makecmap_options, "inflated", views="t4", rgloptions = rgloptions, rglactions = rglactions)
coloredmesh.plot.colorbar.separate(coloredmeshes, png_options = list(filename= paste0(output_image_directory, "age_pos_pvals_", pvalue,"colorbar.png")));
}
