...
fm2 <- lme(mean_within_sys~age_scan+male+fd_mean_avg+avgweight+totalSizet+pctVolsCensored, data = main_long_only, random = ~ 1|base_ID)
...
p <- ggplot(main_long_only, aes(x=age_scan, y=mean_within_sys))+
  geom_point(size=3) +
