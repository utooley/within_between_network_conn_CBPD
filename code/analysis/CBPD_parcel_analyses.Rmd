...
# vec<- mat[lower.tri(mat)]
edge_age_pvals_mat <- matrix(nrow = 400, ncol=400)
edge_age_pvals_mat[lower.tri(edge_age_pvals_mat, diag=FALSE)] <- edgewise_age_betas #take uncorrected p-values for now
#copy lower triangle to upper triangle
...
Need to use Rick's Matlab code to make null models. Or use some kind of null model.
...
Then, compare that to consine similarity between those same pairs of parcels but on randomized null networks generated using Rick's code.
