...
What about the neighborhood questionnaire? That is not in the data that I have.
...
* Significant + effect of parent education on avg connectivity (*p* = 0.01)
```{r replicate VIS-DAN main effect environment plots, echo=FALSE, include=TRUE}
visreg(lm_paredu_sys1to3, "age_scan", by="parent1_edu", overlay=TRUE, breaks = 2)
```
