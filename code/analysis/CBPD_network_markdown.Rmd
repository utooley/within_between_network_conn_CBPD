...
It looks like depending on the degree to which the pipeline takes care of motion, average weight is more or less correlated with motion *test this*. Essentially, how much of the influence of motion are you removing from the data prior to calculating the correlations between regional timeseries.
...
Segregation increases with age
